...
| `z` | The `z` property determines the drawing stack level of the label annotation element. All visible elements will be drawn in crescent order of `z` option, with the same `drawTime` option.
